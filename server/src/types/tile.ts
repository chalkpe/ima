...
export type Tsu =
  | { type: KoritsuType; tiles: Koritsu; open?: boolean; furo?: boolean }
  | { type: TatsuType; tiles: Tatsu; open?: boolean; furo?: boolean }
  | { type: MentsuType; tiles: Mentsu; open?: boolean; furo?: boolean }
